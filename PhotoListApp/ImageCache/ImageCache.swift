...
public protocol ImageCacheActions: AnyObject {
...
public final class ImageCache: ImageCacheActions {
    ...
    public struct Config {
        ...
        public static let defaultConfig = Config(countLimit: 1024, memoryLimit: 1024 * 1024 * 1024) // 100 MB
    }
...
public final class ImageLoader {
    ...
    private let cache: ImageCacheActions
    ...
    public init(cache: ImageCacheActions = ImageCache()) {
        self.cache = cache
    }
    ...
    public func loadImage(from url: URL) -> AnyPublisher<UIImage?, Never> {
        ...
        return URLSession.shared.dataTaskPublisher(for: url)
            ...
            .catch { error in return Just(UIImage(named: "photo")) }
